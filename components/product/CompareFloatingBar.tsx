                ...
                <div className="flex items-center justify-between gap-4 rounded-2xl border border-[var(--border-subtle)] bg-[var(--surface-card-strong)] p-4 shadow-2xl backdrop-blur-xl">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                        {compareItems.length >= 1 && (
                            <Link
                                href="/compare"
                                className="bg-primary text-black hover:bg-emerald-400 text-base px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 transition-all shadow-glow whitespace-nowrap"
                            >
