    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 z-50 flex gap-3 border-t border-border-subtle bg-[var(--panel-bg-soft)] p-4 backdrop-blur-lg sm:hidden">
            ...
            <a
                ...
                className="flex-1 bg-primary text-[var(--primary-contrast)] text-base rounded-standard py-3 font-medium flex items-center justify-center gap-2 active:scale-95 transition-transform shadow-glow"
            >
