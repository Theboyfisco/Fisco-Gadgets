      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className="rounded-standard border border-border-subtle bg-[var(--surface-card)] p-8">
          ...
          <form className="space-y-4">
            ...
            <button type="button" className="w-full bg-primary text-[var(--primary-contrast)] hover:bg-[var(--primary-hover)] text-base py-3 rounded-md font-bold transition-colors mt-4">
              Send Message
            </button>
          </form>
        </div>
