    ...
    <div className="min-h-screen bg-transparent pb-24 lg:pb-12">
      <main className="container mx-auto px-4 pt-8">
        <div className="mb-16 grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <Reveal delay={0.06} className="flex flex-col">
            ...
            <div className="mb-8 grid grid-cols-2 gap-4">
              <div className="rounded-standard border border-[var(--border-subtle)] bg-[var(--surface-card)] p-4 transition-transform duration-300 hover:-translate-y-1">
        ...
        <Reveal className="mx-auto mt-16 max-w-4xl">
          <h2 className="mb-8 text-2xl font-bold text-[var(--foreground)]">Technical Specifications</h2>
          <div className="overflow-hidden rounded-2xl border border-[var(--border-subtle)] bg-surface/60 p-6 shadow-glass backdrop-blur-md">
            <div className="grid grid-cols-1 gap-x-12 gap-y-6 md:grid-cols-2">
              {Object.entries(product.technicalSpecs).map(([key, value]) => (
                <div key={key} className="border-b border-[var(--border-subtle)] pb-4">
